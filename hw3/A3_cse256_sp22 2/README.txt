...
For answer of Unigram Language Model Analysis: Analysis on In-Domain Text and Analysis on Out-of-Domain Text,
> run hw2.py

For answer of Implement a Context-aware Language Model
> run hw3.py

For answer of Adaption
> run Adaption.py
