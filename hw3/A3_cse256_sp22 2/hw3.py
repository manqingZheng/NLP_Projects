...
if __name__ == "__main__":
    ...
    for dname in dnames:
        ...
        datas.append(data)
        model= learn_trigram(data,0.000001,0.01,'True',4)
        # unkowns.append(unk)
        models.append(model)
    ...
    print("-------------------------------")
    print("x train")
    print_table(perp_train, dnames, dnames, "table-train-4.tex")
    print("-------------------------------")
    print("x dev")
    print_table(perp_dev, dnames, dnames, "table-dev-4.tex")
    print("-------------------------------")
    print("x test")
    print_table(perp_test, dnames, dnames, "table-test-4.tex")
